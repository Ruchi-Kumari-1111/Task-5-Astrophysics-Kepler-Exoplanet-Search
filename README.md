...
![Terminal Output 1](Screenshots/1.png)
...
![Terminal Output 2](Screenshots/2.png)

---

## 3. Ensemble Learning & Feature Importance
...
The bar chart below ranks the physical metrics by their predictive power. It mathematically demonstrates which properties are the strongest indicators of an actual orbiting body.

![Feature Importances](Screenshots/3_Feature_Importances.png)

### Predictive Power & Terminal Output

Below is the terminal output comparing the ensemble model's accuracy against a single tree, along with the interpretation of the feature weights:

![Terminal Output 3](Screenshots/3.png)
...
![Terminal Output 4](Screenshots/4.png)
